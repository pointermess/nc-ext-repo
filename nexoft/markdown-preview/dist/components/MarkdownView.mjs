...
(function() {
    ...
    style.setAttribute('data-extension-css', 'components/MarkdownView.mjs');
...
import { defineComponent, ref, onMounted, onUnmounted, createElementBlock, openBlock, createElementVNode } from "vue";
const decodeCache = {};
...
const _hoisted_1 = { class: "markdown-view nexcode-markdown-preview-extension" };
const _hoisted_2 = {
  key: 0,
  class: "empty-state"
};
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "MarkdownView",
  setup(__props) {
    const nexcode = window.nexcode;
    const editor = nexcode == null ? void 0 : nexcode.editor;
    const content = ref("");
    ...
    function updateContent() {
      if ((editor == null ? void 0 : editor.activeFile) && typeof editor.activeFile.content === "string") {
    ...
    onMounted(() => {
      ...
      updateContent();
      if (nexcode == null ? void 0 : nexcode.events) {
        disposables.push(
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        !hasContent.value ? (openBlock(), createElementBlock("div", _hoisted_2, [..._cache[0] || (_cache[0] = [
          createElementVNode("div", { class: "empty-icon" }, "📝", -1),
          createElementVNode("div", { class: "empty-title" }, "Markdown Preview", -1),
          createElementVNode("div", { class: "empty-description" }, "Open a markdown file to see the preview", -1)
...
//# sourceMappingURL=MarkdownView.mjs.map
