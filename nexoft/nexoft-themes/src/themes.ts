/**
 * Nexoft Themes - Theme Definitions
 * 
 * A collection of beautiful color themes for NexCODE.
 * Each theme defines CSS variables for the IDE's UI and syntax highlighting.
 */
...
export const catppuccinMocha: ThemeDefinition = {
    ...
    colors: {
        ...
        // Depth
        '--color-bg-level-0': '#11111b', // Crust
        '--color-bg-level-1': '#181825', // Mantle
        '--color-bg-level-2': '#1e1e2e', // Base
        '--color-bg-level-3': '#313244', // Surface0

        // Borders
        '--color-border': '#45475a',
        '--color-border-muted': '#313244',
        '--color-border-active': '#cba6f7', // Mauve
        ...
        '--color-text-subtle': '#6c7086', // Overlay0

        // Accents (Mauve - purple)
        '--color-accent': '#cba6f7',
        '--color-accent-hover': '#f5c2e7', // Pink
    ...
    tokenColors: [
        ...
        { scope: 'keyword', settings: { foreground: '#cba6f7' } }, // Mauve
        { scope: 'string', settings: { foreground: '#a6e3a1' } }, // Green
        { scope: 'number', settings: { foreground: '#fab387' } }, // Peach
        { scope: 'function', settings: { foreground: '#89b4fa' } }, // Blue
        { scope: 'variable', settings: { foreground: '#cdd6f4' } }, // Text
        { scope: 'type', settings: { foreground: '#f9e2af' } }, // Yellow
        { scope: 'tag', settings: { foreground: '#cba6f7' } }, // Mauve
        { scope: 'attribute', settings: { foreground: '#89dceb' } }, // Sky
        { scope: 'operator', settings: { foreground: '#89dceb' } }, // Sky
        { scope: 'property', settings: { foreground: '#89b4fa' } }, // Blue
    ]
}
...
export const catppuccinLatte: ThemeDefinition = {
    ...
    colors: {
        ...
        // Depth
        '--color-bg-level-0': '#e6e9ef', // Mantle
        '--color-bg-level-1': '#eff1f5', // Base
        '--color-bg-level-2': '#e6e9ef', // Mantle
        '--color-bg-level-3': '#dce0e8', // Crust

        // Borders
        '--color-border': '#ccd0da',
        '--color-border-muted': '#dce0e8',
        '--color-border-active': '#8839ef', // Mauve
        ...
        '--color-text-subtle': '#9ca0b0', // Overlay0

        // Accents (Mauve - purple)
        '--color-accent': '#8839ef',
        '--color-accent-hover': '#ea76cb', // Pink
    ...
    tokenColors: [
        ...
        { scope: 'keyword', settings: { foreground: '#8839ef' } }, // Mauve
        { scope: 'string', settings: { foreground: '#40a02b' } }, // Green
        { scope: 'number', settings: { foreground: '#fe640b' } }, // Peach
        { scope: 'function', settings: { foreground: '#1e66f5' } }, // Blue
        { scope: 'variable', settings: { foreground: '#4c4f69' } }, // Text
        { scope: 'type', settings: { foreground: '#df8e1d' } }, // Yellow
        { scope: 'tag', settings: { foreground: '#8839ef' } }, // Mauve
        { scope: 'attribute', settings: { foreground: '#04a5e5' } }, // Sky
        { scope: 'operator', settings: { foreground: '#04a5e5' } }, // Sky
        { scope: 'property', settings: { foreground: '#1e66f5' } }, // Blue
    ]
}
